using Demo.WebApp.Tests.Config;
using Demo.WebApp.Tests.Order;
using Demo.Auth.Api;
...
namespace Demo.WebApp.Tests
{
    ...
    public class UsuarioTests
    {
        ...
        {
            // Arrange
            var initialResponse = await _testsFixture.Client.GetAsync(":4200/conta/cadastro");
